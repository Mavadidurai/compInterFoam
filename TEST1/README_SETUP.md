...
Cannot find file "points" in directory "TEST1/polyMesh" in times "0" down to constant
```
...
The TEST1 case requires mesh generation before running the solver. Follow these steps:
...
- **Total cells:** ~1.49 million (80 × 466 × 40)
- **Substrate:** 40 cells (8 μm thick)
- **Air gap:** 60 cells (12 μm thick)
- **Ti film:** 36 cells (71.4 nm thick) - ablation zone
- **Grading:** Uniform spacing (simpleGrading 1 1 1)
