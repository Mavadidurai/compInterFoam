#!/usr/bin/env python3
"""
Setup case directories for mesh convergence study - TEST2

This script creates complete OpenFOAM case directories for each refinement level.
It copies the TEST2 case structure and installs the appropriate blockMeshDict.
"""
...
echo "Running mesh convergence study - TEST2 - {level}"
echo "=================================================="
echo ""
...
def main():
    ...
    base_case = os.path.dirname(script_dir)  # Parent directory (TEST2)
    meshes_dir = os.path.join(script_dir, 'meshes')
    cases_dir = os.path.join(script_dir, 'cases')

    print("="*70)
    print("Mesh Convergence Study - TEST2 Case Setup")
    print("="*70)
    print()
